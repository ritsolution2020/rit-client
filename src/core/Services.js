			...
			<div className="col-md-6 col-lg-4">
				<div className="single-service">
					<div className="content">
						...
						<h3 className="title">Soft Development</h3>
						<p className="description">Mauris volutpat urna tristique finibus iaculis. Morbi facilisis, justo eu vulputate elementum, urna tristique finibus iaculis. Morbi facilisis est augue tincidunt ante, sed efficitur leo ligula vel velit.</p>
			...
			<div className="col-md-6 col-lg-4">
				<div className="single-service">
					<div className="content">
						...
						<p className="description">Mauris volutpat urna tristique finibus iaculis.urna tristique finibus iaculis. Morbi facilisis Morbi facilisis, justo eu vulputate elementum, est augue tincidunt ante, sed efficitur leo ligula vel velit.</p>
